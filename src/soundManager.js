...
class SoundManager {
    ...
    initializeSounds() {
        const soundList = [
            ...
            { name: 'click', url: '/src/assets/sfx/photos-click.mp3', volume: 0.4 },
            { name: 'menuClick', url: '/src/assets/sfx/photos-menu-click.mp3', volume: 0.4 },
            { name: 'hover', url: '/src/assets/sfx/nock.mp3', volume: 0.2 },
            { name: 'tick', url: '/src/assets/sfx/tick.mp3', volume: 0.15 },
            { name: 'knock', url: '/src/assets/sfx/nock.mp3', volume: 0.5 },
            { name: 'scroll', url: '/src/assets/sfx/scrollwheel.mp3', volume: 0.3 },
            { name: 'command', url: '/src/assets/sfx/command-press.mp3', volume: 0.6 },
            { name: 'takeout', url: '/src/assets/sfx/takeout-click.mp3', volume: 0.4 },

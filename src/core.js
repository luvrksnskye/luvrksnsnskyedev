...
class CoreManager {
    ...
    setupNavigationAnimations() {
        // Navigation.js already calls animationsManager.navigateToPage()
        // internally during screen transitions. No method override needed.
        console.log('[CORE] Navigation-animations coordination ready');
    }

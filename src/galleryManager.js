    ...
    constructor() {
        this.galleries = {
            ...
            places: [
                ...
                '/src/assets/gallery/skull.JPEG',
                '/src/assets/gallery/t-rex.JPEG',
                '/src/assets/gallery/myfootlol.JPEG',
                '/src/assets/gallery/dinosaur.JPEG',
                '/src/assets/gallery/cutiedino.JPEG',
                '/src/assets/gallery/chinesewall.jpg',
                '/src/assets/gallery/church.jpg',
                '/src/assets/gallery/skyline.JPEG',
                '/src/assets/gallery/skyline2.jpg',
                '/src/assets/gallery/skyline3.JPEG',
                '/src/assets/gallery/skyline4.JPEG',
                '/src/assets/gallery/idkbutitscool.jpg',
                '/src/assets/gallery/garden.jpg',
                '/src/assets/gallery/bigdino.JPEG',
            ],
            heart: [
                ...
                '/src/assets/gallery/us_omori.png'
            ],
            cat: [

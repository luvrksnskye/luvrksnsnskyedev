...
class ToolsManager {
    constructor() {
        ...
        this.tools = [
            ...
            { name: 'Kitty', image: '/src/assets/kitty-dark-icon.png', description: 'kitty is designed for power keyboard users. To that end all its controls work with the keyboard (although it fully supports mouse interactions as well). Its configuration is a simple, human editable, single file for easy reproducibility (I like to store configuration in source control).' },
            { name: 'Blender', image: '/src/assets/blender-icon.png', description: '3D modeling and animation software for creating assets, environments, and animations for games and visual projects.' },
            { name: 'Affinity', image: '/src/assets/affinity-icon.png', description: 'Affinity comes with built-in Vector, Pixel, and Layout studios, but you’re not locked in. Rearrange panels and mix and match your favorite tools to build custom studios. You can save multiple setups, switch between them in a click, and even share with others or download theirs. It’s customization that flexes to your workflow.' },
            ...
            { name: 'Garageband', image: '/src/assets/garageband-icon.png', description: 'I currently use it to edit sounds and music. GarageBand is a fully featured music creation studio right inside your Mac, with a complete sound library including instruments, guitar and vocal presets, and an incredible selection of session drummers and percussionists.' },
            { name: 'Docker', image: '/src/assets/docker-icon.png', description: 'Platform for developing, shipping, and running applications in containers, ensuring consistency across different environments. I personally use it for personal stuff!' },
            { name: 'Trello', image: '/src/assets/trello-icon.png', description: 'Project management tool that helps organize tasks, collaborate with team members, and track project progress using boards, lists, and cards.' }
        ];
